...
- `shared/` — reusable pieces shared across features: `widgets/` (empty — screens use stock Material 3 widgets styled via `core/theme/`, not a custom UI kit), `models/`, `providers/` (cross-feature Riverpod providers).
